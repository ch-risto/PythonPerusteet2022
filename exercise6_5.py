...
# pyydetään käyttäjältä tuotekoodi
order_number = input("Syötä tuotekoodi:\n")

# luodaan silmukka, joka käy kaikki tilaukset läpi
for p in products:
    ...
    # jos tilausnumero löytyy, tulostetaan vuosiluku
    if order_number == order:
        print(f"Tilauksen vuosiluku: {year}")
        break
    # jos ei, käydään silmukka loppuun
    else:
        continue